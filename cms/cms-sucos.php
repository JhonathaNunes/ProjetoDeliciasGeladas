<?php
    ...
    if (isset($_POST['btnSalvar'])){
        ...
        if ($nomeArq1 != null){
            if(strstr($nomeArq1, '.jpg') || strstr($nomeArq1, '.png')){
                ...
                if(move_uploaded_file($_FILES['fleFoto1']['tmp_name'], $uploadFile)){
                    $sql = "UPDATE tbl_suco set imagem1 ='".$uploadFile."' WHERE idSuco = 1;";
        ...
        if ($nomeArq2 != null){
            if(strstr($nomeArq2, '.jpg') || strstr($nomeArq2, '.png')){
                ...
                if(move_uploaded_file($_FILES['fleFoto2']['tmp_name'], $uploadFile)){
                    $sql = "UPDATE tbl_suco set imagem2='".$uploadFile."' WHERE idSuco = 1;";
        ...
        if ($nomeArq3 != null){
            if(strstr($nomeArq3, '.jpg') || strstr($nomeArq3, '.png')){
                ...
                if(move_uploaded_file($_FILES['fleFoto3']['tmp_name'], $uploadFile)){
                    $sql = "UPDATE tbl_suco set imagem3 = '".$uploadFile."' WHERE idSuco = 1;";
        ...
        if($texto1 != null){
            $sql = "UPDATE tbl_suco set texto1 = '".$texto1."' WHERE idSuco = 1;";

            mysqli_query(ConexaoDb(), $sql);
        }

        if($texto2 != null){
            $sql = "UPDATE tbl_suco set texto2 = '".$texto2."' WHERE idSuco = 1;";

            mysqli_query(ConexaoDb(), $sql);
        }

        if($texto3 != null){
            $sql = "UPDATE tbl_suco set texto3 = '".$texto3."' WHERE idSuco = 1;";
...
<html lang="pt-BR">
    ...
    <body>
        <div id="holder">
            ...
            <?php criaMenu() ?>
            <main>
                <h1 id="tituloPagina">Página Suco</h1>

                <form name="frmVerao" method="post" action="cms-sucos.php" enctype="multipart/form-data">
                    <!--Select para preencher os campos com os dados cadastrados-->
                    <?php
                    ...
                    <div id="editaConteudo">
                        <div class="fotos">
                            ...
                            <div class="mostrarImg">
                                <img class="imgExemplo" src="<?php echo($rs['imagem1'])?>" alt="">
                            </div>
                        </div>
                        ...
                        <div class="fotos">
                            ...
                            <div class="mostrarImg">
                                <img class="imgExemplo" src="<?php echo($rs['imagem2'])?>" alt="">
                            </div>
                        </div>
                        <div class="textos">
                        ...
                        <div class="fotos">
                            ...
                            <div class="mostrarImg">
                                <img class="imgExemplo" src="<?php echo($rs['imagem3'])?>" alt="">
                            </div>
                        </div>
                        <div class="textos">
